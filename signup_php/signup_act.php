...
// var_dump($weight);
// exit();
    $sql = 'INSERT INTO user(id,name,age,city,gender,shop,height,weight,email,password,created_at,is_deleted) VALUES(NULL,:name,:age,:city,:gender,:shop,:height,:weight,:email,:password,sysdate(),0)';
